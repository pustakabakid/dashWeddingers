...
INSERT INTO public.invitation_settings (
    id, couple, wedding_date, day_name, formatted_date, formatted_date_short, default_guest, audio_url, live_stream_url, schedules, love_stories, bank_accounts, gallery_images, feature_flags, invitation_url, wa_template
) 
VALUES (
    'default',
    '{
